...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashPassword = bcryptjs_1.default.hashSync(password, Number(env_1.envVars.BCRYPT_SALT_ROUND));
    const authProviders = {
        provider: 'google',
        providerId: email,
    };
    const user = yield user_model_1.User.create(Object.assign(Object.assign({ email }, rest), { auths: [authProviders], password: hashPassword }));
    return user;
});

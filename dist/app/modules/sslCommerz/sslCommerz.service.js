...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log('ssl validated api response', response.data);
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGatewayData: (yield response).data }, { runValidators: true });
    }
    catch (error) {
        console.log(error);
